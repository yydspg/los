...
public class BeanKit{
    ...
    public static void copyProperties(Object objectFrom, Object objectTo) {
        BeanUtil.copyProperties(objectFrom, objectTo);
    }
    ...
    public static String formatKeyValuePair(Object object) {
        ...
        //获取对象字段
        String[] fieldNames = BeanKit.getFiledName(object);
        //遍历所有属性
        for (int j = 0; j < fieldNames.length; j++) {
            ...
            //获取值
            Object value = BeanKit.getFieldValueByName(key, object);
            assert value != null;
    ...
    public static <T> T formatKeyValuePair(String str, T t) {
        ...
        //获取对象字段
        String[] fieldNames = BeanKit.getFiledName(t);
